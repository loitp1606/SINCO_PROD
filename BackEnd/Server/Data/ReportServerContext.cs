...
public partial class ReportServerContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.UserGroupId).HasName("PK__UserGroup__FA5A61C07BFB9F93");

            entity.Property(e => e.UserGroupId).UseIdentityColumn();
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.Description).HasMaxLength(255);
            ...
            entity.Property(e => e.UpdatedAt).HasColumnType("datetime");
            entity.Property(e => e.ListUser).HasMaxLength(1024);
        });

        modelBuilder.Entity<UserGroupMenuPermission>(entity =>
        {
            //entity.HasNoKey();
            entity.HasKey(e => e.MenuId).HasName("PK__UserGroupMenuPermission__5E548648C65CF378");
        ...
        {
            //entity.HasNoKey();
            entity.HasKey(e => e.MenuId).HasName("PK__UserMenuPermission__5E548648C65CF378");
